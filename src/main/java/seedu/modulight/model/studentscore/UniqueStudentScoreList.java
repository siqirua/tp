...
public class UniqueStudentScoreList implements Iterable<StudentScore> {
    ...
    public void setStudentScores(seedu.modulight.model.studentscore.UniqueStudentScoreList replacement) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof seedu.modulight.model.studentscore.UniqueStudentScoreList)) {
            return false;
        }

        seedu.modulight.model.studentscore.UniqueStudentScoreList otherUniquePersonList =
                (seedu.modulight.model.studentscore.UniqueStudentScoreList) other;
